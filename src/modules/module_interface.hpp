...
protected:
	...
	explicit IModule (QWidget* parent);
...
public:
	 ...
	 */
	virtual
	void activate(SceneInspector* sceneInspector, LGScene* scene) = 0;
	...
	virtual
	QMenu* getSceneInspectorMenu() = 0;

	virtual
	std::vector<QMenu*> getMenus() = 0;


	QWidget* parentWidget()				{return _parent;}
	const QWidget* parentWidget() const	{return _parent;}
