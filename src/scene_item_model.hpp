...
////////////////////////////////////////////////////////////////////////
//	type definitions
using SceneItemInfoVec = std::vector<SceneItemInfo*>;
...
{
	unsigned int _type;
	SceneItemInfo* _parent;
	SceneItemInfoVec _children;

	ISceneObject* _obj;///<	the associated scene-object (valid for subsets too).
	int _index;///<	used as subset-index if type == SIT_SUBSET
};
...
class SceneItemModel : public QAbstractItemModel {
	...
	public:
		...
		~SceneItemModel() override = default;
	...
	protected:
		...
		QModelIndex indexFromItemInfo(SceneItemInfo* itemInfo, int column) const;
	...
	protected:
		IScene* _scene;
		SceneItemInfoVec	_item_infos;

	//	Icons
		QIcon	_icon_visible;
		QIcon	_icon_invisible;
		QIcon	_icon_color;
};
