...
class WidgetContainer : public QFrame {
	...
	public:
		explicit WidgetContainer(QWidget* parent);

		~WidgetContainer() override = default;
...
class WidgetContainerSeparator : public QFrame {
	...
	public:
		explicit WidgetContainerSeparator(QWidget* parent);

		~WidgetContainerSeparator() override = default;
};
