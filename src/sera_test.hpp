...
private:
	...
	void serialize( Archive& ar, const unsigned int version)
	{
		...
		ar & ug::make_nvp("id", _id);
		ar & ug::make_nvp("name", _name);
		ar & ug::make_nvp("pos", _pos);
	}
};
...
private:
	...
	void serialize( Archive& ar, const unsigned int version)
	{
		...
		ar & ug::make_nvp("properties", _properties);
		ar & ug::make_nvp("int", _int);
	}
};
