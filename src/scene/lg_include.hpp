...
namespace ug
{
	using ASphere = Attachment<Sphere3>;


////////////////////////////////////////////////////////////////////////
//	Methods
///	calculates the a bounding sphere of a face.
void CalculateBoundingSphere(Sphere3& sphereOut, Face* f, Grid::VertexAttachmentAccessor<APosition>& aaPos);

///	calculates the a bounding sphere of a volume.
void CalculateBoundingSphere(Sphere3& sphereOut, Volume* v, Grid::VertexAttachmentAccessor<APosition>& aaPos);

///	if at least one point of the edge lies outside of the plane, the method returns true.
bool ClipEdge(Edge* e, Plane& clipPlane, Grid::VertexAttachmentAccessor<APosition>& aaPos);

///	if at least one point of the face lies outside of the plane, the method returns true.
bool ClipFace(Face* f, const Sphere3& boundingSphere, Plane& clipPlane, Grid::VertexAttachmentAccessor<APosition>& aaPos);

///	if at least one point of the volume lies outside of the plane, the method returns true.
bool ClipVolume(Volume* v, const Sphere3& boundingSphere, Plane& clipPlane, Grid::VertexAttachmentAccessor<APosition>& aaPos);
